...
function MD5Memory(Memory: PByte; Size: LongWord): MD5Digest;
...
function MD5String(M: String): MD5Digest;
begin
  Result := MD5Memory(PByte(PChar(M)), Length(M)*SizeOf(Char));
end;
