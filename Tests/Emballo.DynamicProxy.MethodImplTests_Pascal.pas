...
unit Emballo.DynamicProxy.MethodImplTests_Pascal;
...
type
  TTestClass = class
  public
    procedure ConstDoubleParam(const A: Double); pascal;
    function IntegerResult: Integer; pascal;
    function DoubleResult: Double; pascal;
    procedure OutStringParameter(out S: String); pascal;
    function FunctionWithStringResult: String; pascal;
  end;

  TMethodImplTests_Pascal = class(TTestCase)
  private
...
{ TMethodImplTests_Pascal }

function TMethodImplTests_Pascal.GetMethod(const Name: String;
  const InvokationHandler: TInvokationHandlerAnonMethod): TMethodImpl;
begin
  Result := TMethodImpl.Create(FRttiContext, FRttiType.GetMethod(Name), InvokationHandler);
end;

procedure TMethodImplTests_Pascal.SetUp;
begin
  inherited;
...
procedure TMethodImplTests_Pascal.TearDown;
begin
  inherited;
  FRttiContext.Free;
end;

procedure TMethodImplTests_Pascal.TestDoubleResult;
var
  MethodImpl: TMethodImpl;
  M: function: Double of object; pascal;
...
procedure TMethodImplTests_Pascal.TestFunctionWithStringResult;
var
  MethodImpl: TMethodImpl;
  M: function: String of object; pascal;
  InvokationHandler: TInvokationHandlerAnonMethod;
  ReturnValue: String;
begin
  InvokationHandler := procedure(const Method: TRttiMethod;
...
procedure TMethodImplTests_Pascal.TestIntegerResult;
var
  MethodImpl: TMethodImpl;
  M: function: Integer of object; pascal;
  InvokationHandler: TInvokationHandlerAnonMethod;
  ReturnValue: Integer;
begin
  InvokationHandler := procedure(const Method: TRttiMethod;
...
procedure TMethodImplTests_Pascal.TestOutStringParameter;
var
  MethodImpl: TMethodImpl;
  M: procedure(out S: String) of object; pascal;
  InvokationHandler: TInvokationHandlerAnonMethod;
  Str: String;
begin
  InvokationHandler := procedure(const Method: TRttiMethod;
...
procedure TMethodImplTests_Pascal.ConstParametersShouldBeReadOnly;
var
  MethodImpl: TMethodImpl;
  M: procedure(const A: Double) of object; pascal;
  InvokationHandler: TInvokationHandlerAnonMethod;
begin
  InvokationHandler := procedure(const Method: TRttiMethod;
    const Parameters: TArray<IParameter>; const Result: IParameter)
...
initialization
RegisterTest('Emballo.DynamicProxy', TMethodImplTests_Pascal.Suite);
